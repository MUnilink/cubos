select
    ...
    CAST(COALESCE(SD1.D1_VALIPI, 0) AS DECIMAL(14, 2)) AS VL_IPI_COMPRA,
    CAST(COALESCE(SD1.D1_VALFRE, 0) AS DECIMAL(14, 2)) AS VL_FRETE_NF,
    CAST(COALESCE(SD1.D1_DESPESA, 0) AS DECIMAL(14, 2)) AS VL_DESPESA,
    CAST(COALESCE(SD1.D1_TOTAL, 0) AS DECIMAL(14, 2)) AS VL_COMPRA_MERCADORIA,
    ...
    CAST(COALESCE(SD1.D1_QUANT, 0) AS DECIMAL(13, 3)) AS QTD_COMPRA_ITEM,
    CAST(COALESCE(SD1.D1_VALISS, 0) AS DECIMAL(14, 2)) AS VL_ISS_COMPRA,
    CAST(COALESCE(SD1.D1_ICMSRET, 0) AS DECIMAL(14, 2)) AS VL_ICMS_SUBST_COMPRA,
    CAST(COALESCE(SD1.D1_DESC, 0) AS DECIMAL(12, 2)) AS VL_DESCONTO_COMPRA,
    CAST(COALESCE(SD1.D1_VALIRR, 0) AS DECIMAL(14, 2)) AS VL_IRF_COMPRA,
    CAST(COALESCE(SD1.D1_VALINS, 0) AS DECIMAL(14, 2)) AS VL_INSS_COMPRA,
