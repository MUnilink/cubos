select
	...
	cast(coalesce(SC7.C7_QUANT, 0) as numeric(13, 3)) as QTD_ITEM_PC,

    cast(coalesce(SD1.D1_VALICM, 0) as numeric(14, 2)) as VL_NFENT_ICMS,
    cast(coalesce(SD1.D1_VALIPI, 0) as numeric(14, 2)) as VL_NFENT_IPI,
    cast(coalesce(SD1.D1_VALFRE, 0) as numeric(14, 2)) as VL_NFENT_FRETE_NF,
    cast(coalesce(SD1.D1_DESPESA, 0) as numeric(14, 2)) as VL_NFENT_DESPESA,
    cast(coalesce(SD1.D1_TOTAL, 0) as numeric(14, 2)) as VL_NFENT_MERCADORIA,
    cast(coalesce(SD1.D1_VALIMP6, 0) as numeric(14, 2)) as VL_NFENT_PIS,
    cast(coalesce(SD1.D1_VALIMP5, 0) as numeric(14, 2)) as VL_NFENT_COFINS,
    cast(coalesce(SD1.D1_VALISS, 0) as numeric(14, 2)) as VL_NFENT_ISS,
    cast(coalesce(SD1.D1_ICMSRET, 0) as numeric(14, 2)) as VL_NFENT_ICMS_SUBST,
    cast(coalesce(SD1.D1_DESC, 0) as numeric(12, 2)) as VL_NFENT_DESCONTO,
    cast(coalesce(SD1.D1_VALIRR, 0) as numeric(14, 2)) as VL_NFENT_IRF,
    cast(coalesce(SD1.D1_VALINS, 0) as numeric(14, 2)) as VL_NFENT_INSS,
	cast(coalesce(SD1.D1_SEGURO, 0) as numeric(14, 2)) as VL_NFENT_SEGURO,
	cast(coalesce(SD1.D1_QUANT, 0) as numeric(13, 3)) as QTD_ITEM_NFENT,
	cast(coalesce(SD1.D1_PESO * SD1.D1_QUANT, 0) as numeric(12, 4)) as PESO_LIQUIDO_NFENT,
