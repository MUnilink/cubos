select
    ...
    SR7.CARGO as CARGO_PRO,

    case when SR7.CARGO != SR7.CARGO_ANT then 1 + datediff(day, concat(SRD.RD_DATARQ, '01'), SR7.DATA_MUD) else 0 end as DIAS_ANT,
    case
        when SR7.CARGO != SR7.CARGO_ANT then datediff(day, SR7.DATA_MUD, eomonth(concat(SRD.RD_DATARQ, '01')))
