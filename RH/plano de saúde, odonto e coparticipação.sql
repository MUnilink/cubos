...
union
    select /* PLANO DE SAÚDE E ODONTO */
        ...
        case when RHR.RHR_PD in (87, 565, 571) then (select top 1 lead(SR8010.R8_CID, 1, SR8010.R8_CID) over(partition by SR8010.R8_FILIAL, SR8010.R8_MAT order by SR8010.R8_MAT) from SR8010 (nolock) where SR8010.D_E_L_E_T_ = '' and SR8010.R8_PD != 130 and SR8010.R8_FILIAL = RHR.RHR_FILIAL and SR8010.R8_MAT = RHR.RHR_MAT) else null end as ULTIMO_AFASTAMENTO
