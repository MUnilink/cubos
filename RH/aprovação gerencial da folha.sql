    select
        ...
        case when SRC.RC_PD in ('182', '183', '999') then SRC.RC_VALOR else 0.0 end as VALOR_LIQUIDO,
        ...
        case when SRC.RC_PD in ('011', '353') then SRC.RC_VALOR else 0.0 end as ADIC_TEMPOSERVICO,
        case when SRC.RC_PD in ('057') then SRC.RC_VALOR else 0.0 end as DIARIAS,
        case when SRC.RC_PD in ('061', '062', '063', '064', '112', '113', '116', '344', '370') then SRC.RC_VALOR else 0.0 end as HREXTRA_APROVADA,
        ...
        case when SRC.RC_PD in ('373', '414', '530', '532', '533', '535') then SRC.RC_VALOR else 0.0 end as PENSAO_ALIM,
...
union
    select
        ...
        case SRD.RD_PD when '990' _SALARIO else , then SRA.0.0 end as SALARIO_BASE,
        case when SRD.RD_PD in ('182', '183', '999') then SRD.RD_VALOR else 0.0 end as VALOR_LIQUIDO,
        ...
        case when SRD.RD_PD in ('011', '353') then SRD.RD_VALOR else 0.0 end as ADIC_TEMPOSERVICO,
        case when SRD.RD_PD in ('057') then SRD.RD_VALOR else 0.0 end as DIARIAS,
        case when SRD.RD_PD in ('061', '062', '063', '064', '112', '113', '116', '344', '370') then SRD.RD_VALOR else 0.0 end as HREXTRA_APROVADA,
        ...
        case when SRD.RD_PD in ('373', '414', '530', '532', '533', '535') then SRD.RD_VALOR else 0.0 end as PENSAO_ALIM,
