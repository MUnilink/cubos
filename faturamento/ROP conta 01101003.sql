select
    ...
    REC_OPP.CC,
    REC_OPP.ITEM,
    sum(cast(REC_OPP.VALOR as decimal(14, 2))) as TOTAL
from
(
    select
        ...
        coalesce(SD2.D2_VALBRUT, 0) as VALOR
    ...
    where
        ...
        and
            case
                ...
                when trim(CFOP.X5_CHAVE) = '5933' and SD2.D2_TES = '522' then trim(SB1.B1_YCTREC4)
                /* LP 610-040 */
                ...
                /*LP 610-050 */
                when (trim(CFOP.X5_CHAVE) like '[5-6]933' or trim(CFOP.X5_CHAVE) = '7949') and SD2.D2_TES = '522' then trim(SB1.B1_YCTREC5)
                when (trim(CFOP.X5_CHAVE) like '[5-6]933' or trim(CFOP.X5_CHAVE) = '7949') and SD2.D2_TES != '522' then trim(SB1.B1_YCTREC4)
                /* LP 610-015 */
