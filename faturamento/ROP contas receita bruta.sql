...
(
    select
        ...
        case when SF2.F2_ESPECIE = 'CTE' then sum(cast(coalesce(SD2.D2_VALICM, 0) as decimal(14, 2))) else 0.00 end as ICMS,
        case when SF2.F2_ESPECIE = 'RPS' then sum(cast(coalesce(SD2.D2_VALISS, 0) as decimal(14, 2))) else 0.00 end as ISS,
        sum(cast(coalesce(SD2.D2_VALIMP6, 0) as decimal(14, 2))) as PIS,
        sum(cast(coalesce(SD2.D2_VALIMP5, 0) as decimal(14, 2))) as COFINS,
        sum(cast(coalesce(SD2.D2_DESCON, 0) as decimal(14, 2))) as DESCONTO
