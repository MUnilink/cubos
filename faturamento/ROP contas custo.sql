    ...
    where
            ZC2.D_E_L_E_T_ = ''
        and ZC2.ZC2_TIPO in (2, 3, 6, 12, 14, 17)
        and left(ZC2.ZC2_COMPET, 6) =:PERIODO_DATA
...
union
    select
        ...
        ZE1.ZE1_TIPO as TIPO,
        sum(cast(coalesce(ZE1.ZE1_TOTAL, 0) as decimal (14, 2))) as TOTAL
    from ZE1010 ZE1
    where
            ZE1.D_E_L_E_T_ = ''
        and ZE1.ZE1_TIPO in (2, 3, 6, 12, 14, 17)
        and left(ZE1.ZE1_COMPET, 6) =:PERIODO_DATA
    group by ZE1.ZE1_FILIAL, ZE1.ZE1_NUM, ZE1.ZE1_TIPO
