select
    ...
    case when ZG1.ZG1_TABELA = 'SQ3' then (select cast(SRJ010.RJ_YHRPADR as numeric(15, 2)) from SRJ010 where SRJ010.D_E_L_E_T_ = '' and SRJ010.RJ_CARGO = ZG1.ZG1_CODIGO) else ZG1.ZG1_HRPAD end as QTD_UNI,
