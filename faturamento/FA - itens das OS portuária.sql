...
from
    (
        select
            ...
            case when ZC2010.ZC2_QTDPRV > 99999999 then 99999999 when ZC2010.ZC2_QTDPRV < 0.0 then 0.0 else ZC2010.ZC2_QTDPRV end as QTD_PREV,
            case when ZC2010.ZC2_QTDREA > 99999999 then 99999999 when ZC2010.ZC2_QTDREA < 0.0 then 0.0 else ZC2010.ZC2_QTDREA end as QTD_REAL,
            case when ZC2010.ZC2_VLUPRV > 99999999 then 99999999 when ZC2010.ZC2_VLUPRV < 0.0 then 0.0 else ZC2010.ZC2_VLUPRV end as VAL_PREV,
            case when ZC2010.ZC2_VLUREA > 99999999 then 99999999 when ZC2010.ZC2_VLUREA < 0.0 then 0.0 else ZC2010.ZC2_VLUREA end as VAL_REAL,
            case when ZC2010.ZC2_TOTAL > 99999999 then 99999999 when ZC2010.ZC2_TOTAL < 0.0 then 0.0 else ZC2010.ZC2_TOTAL end as VALOR_TOTAL,
