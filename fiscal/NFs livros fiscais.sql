    select
        ...
        left(SD1.D1_EMISSAO, 6) as PERIODO_EMI,
        left(SD1.D1_DTDIGIT, 6) as PERIODO,
        cast(SD1.D1_EMISSAO as date) as DT_EMISSAO,
        cast(SD1.D1_DTDIGIT as date) as DT_DIGITAC,
        cast(SFT.FT_DTCANC as date) as DATA_CANCELAMENTO,
        ...
        cast(SFT.FT_ICMSCOM as numeric(15, 2)) as ICMS_COMPL,
        cast(SFT.FT_DIFAL as numeric(15, 2)) as DIFAL,
...
union
    ...
    from SFT010 SFT (nolock)
        left join SD2010 SD2 (nolock)
            on SD2.D2_FILIAL = SFT.FT_FILIAL
