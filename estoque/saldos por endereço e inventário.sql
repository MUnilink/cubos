select
    ...
    case SB7.B7_STATUS when 1 then 'NAO PROCESSADO' when 2 then 'PROCESSADO' end as STATUS,
    ...
    (select sum(SD3010.D3_QUANT) from SD3010 where SD3010.D_E_L_E_T_ = '' and SD3010.D3_FILIAL = SBF.BF_FILIAL and SD3010.D3_COD = SBF.BF_PRODUTO and SD3010.D3_LOCAL = SBF.BF_LOCAL and SD3010.D3_LOCALIZ = SBF.BF_LOCALIZ and SD3010.D3_DOC = 'INVENT') as MOV_INVENT
from SBF010 SBF
