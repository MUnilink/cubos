SELECT
    ...
    concat(trim(SCP.CP_FILIAL), trim(SCP.CP_NUM)) as ID_PREREQUISIC,
    concat(trim(SCP.CP_FILIAL), trim(SCP.CP_NUM)) as ID_REQUISICAO,
    ...
    SCP.CP_PRECO as VALOR_UNITARIO,
    SCP.CP_TOTAL as VALOR_TOTAL,
