select
	...
	SN3.N3_TIPO,
	trim(SN3.N3_FIMDEPR) as FIMDEPR,
	cast(SN3.N3_DINDEPR as date) as INI_DEPREC,
	cast(SN3.N3_TXDEPR1 /12 as numeric(15, 3)) as DEPREC_MENSAL,
	cast(SNG.NG_TXDEPR1 /12 as numeric(15, 3)) as DEPREC_MENSAL_GRUPO,
	...
	SN3.N3_VRDBAL1 as DEPREC_BALAN,
	SN3.N3_VRDMES1 as VL_DEP_MENSAL,
	SN3.N3_VRDACM1 as VL_DEP_ACUMUL,
	SN3.N3_VMXDEPR as VL_DEP_MAXIMA,
