select
    ...
    datediff(day, SN3.N3_DINDEPR, STP.TP_DTLEITU) /(365.25/12) MESES_ATIVO,
	(100 / (SN3.N3_TXDEPR1 / 365.25))/(365.25/12) as MESES_DEPREC,

	SN3.N3_VORIG1 * ((SN3.N3_TXDEPR1 *.01) / 12) as DEPRECMENSAL,
    case when (365.25 * (100 / SN3.N3_TXDEPR1)) > datediff(day, SN3.N3_DINDEPR, STP.TP_DTLEITU) then SN3.N3_VORIG1 * (SN3.N3_TXDEPR1*.01 / 12) else 0.0 end as DEPRECATUAL
