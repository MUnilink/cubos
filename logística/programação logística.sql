select
    ...
    VIAGEM.DTQ_DATENC as DAT_ENC_VGA,
    ...
    DT6.DT6_DOC as NF_CTE,
    DT6.DT6_SERIE as SERIE,
    DT6.DT6_DATEMI as DT_NFCTE,
    ...
    DT6.DT6_CLIREM +'-'+ DT6.DT6_LOJREM as COD_REMETENTE,
    trim(REM.A1_CGC) as REM_CNPJ,
    trim(REM.A1_NOME) as REMETENTE,
    trim(REM.A1_NREDUZ) as REM_RED,
    
    DT6.DT6_CLIDES +'-'+ DT6.DT6_LOJDES as COD_DESTINATARIO,
    trim(DES.A1_CGC) as DES_CNPJ,
    trim(DES.A1_NOME) as DESTINATARIO,
    trim(DES.A1_NREDUZ) as DES_RED,
    
    DT6.DT6_CLIDEV +'-'+ DT6.DT6_LOJDEV as COD_DEVEDOR,
    trim(DEV.A1_CGC) as CLI_CNPJ,
    trim(DEV.A1_NOME) as CLIENTE,
    trim(DEV.A1_NREDUZ) as CLIENTE_RED,

    DT6.DT6_SERVIC as SERVICO,
    ...
    trim(DF1.DF1_YARMAD) as ARMADORA_COD,
    trim(DF1.DF1_YLJARM) as LOJA_ARMADORA,
