select
	...
	cast(convert(date, DF0.DF0_DATCAD, 103) as varchar) as DATA_AGENDAMENTO,
	...
	case DT6.DT6_DATEMI
		...
		when '' then '-'
		when '        ' then '-'
		else convert(date, substring(DT6.DT6_DATEMI, 1 ,8), 103)
	end as DATA_CTE,
...
from DF0010 as DF0 (nolock)
	inner join DF1010 as DF1 (nolock)
		on DF1.D_E_L_E_T_ = ''
