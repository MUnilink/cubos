    select
        ...
        case when abs(ZC2.ZC2_QTDPRV) > 99999999 then 99999999 else ZC2.ZC2_QTDPRV end as QTD_PREV,
        case when abs(ZC2.ZC2_QTDREA) > 99999999 then 99999999 else ZC2.ZC2_QTDREA end as QTD_REAL,
        case when abs(ZC2.ZC2_VLUPRV) > 99999999 then 99999999 else ZC2.ZC2_VLUPRV end as VAL_PREV,
        case when abs(ZC2.ZC2_VLUREA) > 99999999 then 99999999 else ZC2.ZC2_VLUREA end as VAL_REAL,
        ...
        case when abs(ZC2.ZC2_TOTAL) > 99999999 then 99999999 else ZC2.ZC2_TOTAL end as VALOR_TOTAL,
...
union
    select
        ...
        cast(ZC2.ZC2_QTDREA * ZC2.ZC2_VLUREA as numeric(15, 2)) as VAL_REAL_TOTAL,
        case when abs(ZC2.ZC2_TOTAL) > 99999999 then 99999999 else ZC2.ZC2_TOTAL end as VALOR_TOTAL,
        case when abs(ZC2.ZC2_QTDREC) > 99999999 then 99999999 else ZC2.ZC2_QTDREC end as QTD_RECURSO,
