SELECT
    ...
    (select trim(SC1010.C1_OBS) from SC1010 where SC1010.D_E_L_E_T_ = '' and SC1010.C1_FILIAL = SC1.C1_FILIAL and SC1010.C1_NUM = SC1.C1_NUM and SC1.C1_ITEM = SC1.C1_ITEM group by SC1010.C1_FILIAL, SC1010.C1_NUM having SC1010.C1_ITEM = min(SC1.C1_ITEM)) as OBS_SC
