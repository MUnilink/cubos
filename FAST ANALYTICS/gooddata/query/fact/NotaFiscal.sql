SELECT
    ...
    'P |01|SA3010|'+ COALESCE(NULLIF(RTRIM(COALESCE(SA3.A3_FILIAL, ' '))+'|'+RTRIM(COALESCE(SF2.SF2.F2_VEND1, ' ')), ' '), '|') AS BK_VENDEDOR,
...
FROM SD2010 SD2
    INNER JOIN SF2010 SF2
        ...
        left join SD1010 SD1
            ON SF2.D_E_L_E_T_ = ' '
            AND SD1.D1_FILIAL = SF2.F2_FILIAL
            AND SD1.D1_NFORI = SF2.F2_DOC
            AND SD1.D1_SERIORI = SF2.F2_SERIE
            AND SD1.D1_FORNECE = SF2.F2_CLIENTE
            AND SD1.D1_LOJA = SF2.F2_LOJA
