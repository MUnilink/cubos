SELECT
    ...
    CASE
        WHEN SD2.D2_FILIAL IS NULL THEN 'P |01||'
        ELSE 'P |01|01'+ CAST(SD2.D2_FILIAL AS CHAR (6))
    END AS BK_FILIAL,
    ...
    CASE
        WHEN LTRIM(RTRIM(SF2.F2_EMISSAO)) = ' ' THEN ' '
        ELSE SF2.F2_EMISSAO
    END AS DATA_DE_EMISSAO,
    CASE
        WHEN LTRIM(RTRIM(SF2.F2_EMINFE)) = ' ' THEN ' '
        ELSE SF2.F2_EMINFE
...
FROM SD2010 SD2
    INNER JOIN SF2010 SF2
        ...
        LEFT JOIN SA1010 SA1
            ON A1_FILIAL = '      '
            AND SA1.A1_COD = SF2.SF2.F2_CLIENTE
            AND SA1.A1_LOJA = SF2.SF2.F2_LOJA
            AND SA1.D_E_L_E_T_= ' '
    ...
    INNER JOIN SB1010 SB1
        ON B1_FILIAL = '      '
        AND SB1.B1_COD = SD2.SD2.D2_COD
        AND SB1.D_E_L_E_T_= ' '
    INNER JOIN SF4010 SF4
        ON F4_FILIAL = '      '
        AND SF4.F4_CODIGO = SD2.SD2.D2_TES
        AND SF4.D_E_L_E_T_ = ' '
    ...
    left join CTT010 CTT
        on CTT.D_E_L_E_T_ = ''
        and CTT.CTT_FILIAL = substring(SD2.SD2.D2_FILIAL, 1, 4)
        and CTT.CTT_CUSTO = SD2.SD2.D2_CCUSTO
...
WHERE
    ...
    AND SD2.D_E_L_E_T_ = ' '
    AND SD2.SD2.D2_SERIE NOT IN ('003', '100')
