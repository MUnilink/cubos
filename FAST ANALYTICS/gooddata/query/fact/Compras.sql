SELECT 'P |01|01' AS BK_EMPRESA,
       ...
       'P |01|SB1010|'+ COALESCE(NULLIF(RTRIM(COALESCE(SB1.B1_FILIAL, ' '))+'|'+RTRIM(COALESCE(SB1.B1_CONTA, ' ')), ' '), '|') AS CONTA_PRODUTO,
       'P |01|SB1010|'+ COALESCE(NULLIF(RTRIM(COALESCE(SB1.B1_FILIAL, ' '))+'|'+RTRIM(COALESCE(SB1.B1_YCTCUST, ' ')), ' '), '|') AS CONTA_PRODUTO_CUSTO,
       'P |01|SB1010|'+ COALESCE(NULLIF(RTRIM(COALESCE(SB1.B1_FILIAL, ' '))+'|'+RTRIM(COALESCE(SB1.B1_YCTDEAD, ' ')), ' '), '|') AS CONTA_PRODUTO_DESPE,
       'P |01|SB1010|'+ COALESCE(NULLIF(RTRIM(COALESCE(SB1.B1_FILIAL, ' '))+'|'+RTRIM(COALESCE(SB1.B1_YCTATIV, ' ')), ' '), '|') AS CONTA_PRODUTO_ATIVO
