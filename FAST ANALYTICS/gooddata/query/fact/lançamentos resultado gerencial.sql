select distinct
    ...
    case when (len(ZE2.ZE2_COD) = 8 and left(ZE2.ZE2_COD, 2) = '01') or ZE2.ZE2_COD = '04' then ZE3.ZE3_VALOR when len(ZE2.ZE2_COD) = 8 and left(ZE2.ZE2_COD, 2) like '_[2-9]' then ZE3.ZE3_VALOR*-1 else null end as VALOR
from ZE3010 ZE3
