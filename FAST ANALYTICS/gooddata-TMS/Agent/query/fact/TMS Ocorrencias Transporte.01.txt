SELECT 'P |01|01' AS BK_EMPRESA,
       ...
       DUA_SERIE AS SERIE
FROM DUA010 DUA
INNER JOIN DT2010 DT2 ON DT2.DT2_FILIAL = DUA_FILIAL
AND DT2.DT2_CODOCO = DUA.DUA_CODOCO
AND DT2.D_E_L_E_T_ = ' '
LEFT JOIN DT6010 DT6 ON DUA.DUA_FILIAL = DUA_FILIAL
...
AND DDB.D_E_L_E_T_ = ' '
LEFT JOIN SX5010 SX5 ON SX5.X5_FILIAL = '      ' /*SUBSTRING(DT6_FILIAL, 1, 5) + SUBSTRING(X5_FILIAL, 6, 8)*/
AND SX5.X5_TABELA = 'L4'
AND SX5.X5_CHAVE = DT6.DT6_SERVIC
AND SX5.D_E_L_E_T_ = ' '
WHERE DUA.DUA_DATOCO BETWEEN <<START_DATE>> AND <<FINAL_DATE>>
  AND DUA.D_E_L_E_T_ = ' '