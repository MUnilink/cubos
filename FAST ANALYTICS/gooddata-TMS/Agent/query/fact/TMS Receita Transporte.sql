...
FROM DT8010 DT8
INNER JOIN DT6010 DT6 ON DT6.DT6_FILIAL = DT8_FILIAL
...
LEFT JOIN DUY010 DUYDEV ON DUYDEV.DUY_FILIAL = DT6_FILIAL
AND DUYDEV.DUY_GRPVEN = DT6.DT6_CDRCAL
AND DUYDEV.D_E_L_E_T_ = ' '
INNER JOIN DT3010 DT3 ON DT3.DT3_FILIAL = DT8_FILIAL
...
AND SX5.D_E_L_E_T_ = ' '
WHERE DT6.DT6_DATEMI BETWEEN <<START_DATE>> AND <<FINAL_DATE>>
  AND DT8.D_E_L_E_T_ = ' '