...
from TbCopIte CopIte
    ...
    left join TbCpo Cpo on Cpo.CdCopRem = CopRem.CdCopRem
        ...
        inner join TbCop Cop on Cop.CdCop = CopRem.CdCop
            ...
            ) CopTot on CopTot.CdCop = Cop.CdCop -- AUTORIZAÇÃO
            ...
            (
                ...
                where --Atd.TpAtdRef = 430
                        Atd.NrAtdRef = @CdCop
                    and Atd.CdDmnOpc = 1
            ) Atd on Atd.CdCop = Cop.CdCop -- AUTORIZAÇÃO ISMAEL MARQUES 13/07/2012
            ...
            (
                ...
                and Atd.TpAtdRef = 430
            ) AtdAut on AtdAut.CdCop = Cop.CdCop
